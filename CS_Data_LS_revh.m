function [A_est,D_est] = CS_Data_LS_revh(B, H_est,Y_data_rx, cwsbl,NUM_PILOT,acUsrIndx,acData,par)
...
D_est = acUsrIndx(find(all(bsxfun(@eq,eat_Data(acUsrIndx,:),acData),2)));
